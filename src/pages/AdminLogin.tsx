...
const AdminLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-background px-4 pt-4">
      ...
      <h1 className="text-3xl font-black text-foreground tracking-tight mb-1">Acesso Restrito</h1>
      <p className="text-muted-foreground text-sm mb-8">Login de Administrador</p>
